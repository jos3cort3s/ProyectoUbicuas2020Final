...
public class MainActivityMasterExample extends AppCompatActivity {
    ...
    private EditText deviceIndexInput;
    private Button connectToDevice;
    private Button disconnectDevice;
    private BluetoothGatt bluetoothGatt;
    private FloatingActionButton mFbtn_Connect, secondsFbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_master_example);
    ...
    private final BluetoothGattCallback btleGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, final BluetoothGattCharacteristic characteristic) {
            ...
            MainActivityMasterExample.this.runOnUiThread(new Runnable() {
                public void run() {
